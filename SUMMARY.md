...
## 1. 미래에는 AI가 인간을 대체하게 될까? <a id="1"></a>

* [1.1. Domain Knowledge](1/1.1..md)
* [1.2. 머신러닝을 대하는 엔지니어의 자세](1/1.2..md)

## 2. 시계열 데이터\(Time-Series Data\) 프로젝트

* [2.1. Difference between Traditional Statistics and ML](2.-time-series-data/2.1..md)
* [2.2. Why Deep Learning?](2.-time-series-data/2.2..md)
* [2.3. Time-Series Data](2.-time-series-data/2.3..md)
* [2.4. LSTM](2.-time-series-data/2.4..md)
* [2.5. Data Processing](2.-time-series-data/2.5..md)
...
* [3.1. Why use ML in LPR?](3.-object-recognition/3.1..md)
* [3.2. Why YOLO?](3.-object-recognition/3.2..md)
