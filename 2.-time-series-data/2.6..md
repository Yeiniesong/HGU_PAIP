...
| :--- | :--- | :--- |
| TP\(True Positive\) | 실제 양성을 양성으로 분류 | 불량을 불량으로 정확하게 분류 |
| FP\(False Positive\) | 실제 음성을 양성으로 분류 | 양품을 불량으로 잘못 분 |
| FN\(False Negative\) | 실제 양성을 음성으로 분 | 불량을 양품으로 잘못 분 |
| TN\(True Negative\) | 실제 음성을 음성으로 분류 | 양을 양품로 정확하게 분 |
